	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<!-- Responsive tables Start For customers -->
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>									
									...
									<td><button type="submit" class="badge badge-danger" name="clientID" value="<?php echo $client['id_client'];?>">Delete</span></button></td>
								</tr>
									<?php } ?>
							</tbody>
						</table>
	      ...
	      <th scope="row">1</th>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						<div class="pull-right">
							<a href="form-basic.php" class="btn btn-primary btn-sm scroll-click"> New Actualité</a>
						</div>
					</div>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>									
									...
									<td><?php echo $actualite["texte"];?></td>
									<td><?php echo $actualite["lien"];?></td>
									<td><?php echo $actualite["image"];?></td>
									
									<form action="supprimerActualite.php" method="POST">
									<td><button type="submit" class="badge badge-danger" name="actualiteID" value="<?php echo $actualite['id_actualite'];?>">Delete</button></td>
									</form>
									<form action="modifierActualite.php" method="POST">
									<td><button type="submit" class="badge badge-warning" name="updateActualite" value="<?php echo $actualite['id_actualite'];?>">Update</button></td>
									</form>
									<td><button type="submit" class="badge badge-success">Read</button></td>
								</tr>
									<?php } ?>
							</tbody>
						</table>
